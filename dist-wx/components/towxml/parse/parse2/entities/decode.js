...
function getReplacer(e) {
  return function (t) {
    return "#" === t.charAt(1) ? "X" === t.charAt(2) || "x" === t.charAt(2) ? decode_codepoint_1["default"](parseInt(t.substr(3), 16)) : decode_codepoint_1["default"](parseInt(t.substr(2), 10)) : e[t.slice(1, -1)];
  };
}
...
exports.decodeHTML = function () {
  ...
  for (var t = Object.keys(legacy_json_1["default"]).sort(sorter), r = Object.keys(entities_json_1["default"]).sort(sorter), o = 0, n = 0; o < r.length; o++) t[n] === r[o] ? (r[o] += ";?", n++) : r[o] += ";";
