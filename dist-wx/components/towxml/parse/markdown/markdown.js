!function (e) {
  ...
  return function e(r, t, n) {
    ...
    4: [function (e, r, t) {
      ...
      }, t.isValidEntityCode = c, t.fromCodePoint = l, t.escapeHtml = function (e) {
        return /[&<>"]/.test(e) ? e.replace(/[&<>"]/g, f) : e;
    ...
    17: [function (e, r) {
      ...
      n.prototype.__find__ = function (e) {
        ...
        this.__rules__[n].fn = r, this.__rules__[n].alt = (t || {}).alt || [], this.__cache__ = null;
    ...
    34: [function (e, r) {
      ...
      r.exports = function (e) {
        var r;
        if (e.md.options.typographer) for (r = e.tokens.length - 1; r >= 0; r--) "inline" === e.tokens[r].type && (/\((c|tm|r|p)\)/i.test(e.tokens[r].content) && s(e.tokens[r].children), i.test(e.tokens[r].content) && o(e.tokens[r].children));
      };
    }, {}],
    35: [function (e, r) {
      "use strict";
      ...
      r.exports = function (e) {
        var r;
        if (e.md.options.typographer) for (r = e.tokens.length - 1; r >= 0; r--) "inline" === e.tokens[r].type && /['"]/.test(e.tokens[r].content) && s(e.tokens[r].children, e);
      };
    }, {
      "../common/utils": 4
    }],
          ...
          if (v = {
            ...
            toASCII: function (e) {
              return a(e, function (e) {
                return /[^\x20-\x7E]/.test(e) ? "xn--" + d(e) : e;
              });
            },
            toUnicode: function (e) {
              return a(e, function (e) {
                return /^xn--/.test(e) ? f(e.slice(4).toLowerCase()) : e;
              });
            }
